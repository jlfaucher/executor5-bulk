...
<xsl:param name="tablecolumns.extension" select="0"/> <!-- changed to 0 since we are not using Perl -->
...
<xsl:param name="toc.max.depth">3</xsl:param> <!-- added to keep TOC at 3 levels -->
