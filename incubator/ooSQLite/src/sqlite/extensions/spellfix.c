...
static const struct {
 ...
 unsigned char cTo0, cTo1;
  ...
  { 0x0100,  0x41, 0x00 },  /* A to A */
  { 0x0101,  0x61, 0x00 },  /* a to a */
  { 0x0102,  0x41, 0x00 },  /* A to A */
  { 0x0103,  0x61, 0x00 },  /* a to a */
  { 0x0104,  0x41, 0x00 },  /* A to A */
  { 0x0105,  0x61, 0x00 },  /* a to a */
  { 0x0106,  0x43, 0x00 },  /* C to C */
  { 0x0107,  0x63, 0x00 },  /* c to c */
  { 0x0108,  0x43, 0x68 },  /* C to Ch */
  { 0x0109,  0x63, 0x68 },  /* c to ch */
  { 0x010A,  0x43, 0x00 },  /* C to C */
  { 0x010B,  0x63, 0x00 },  /* c to c */
  { 0x010C,  0x43, 0x00 },  /* C to C */
  { 0x010D,  0x63, 0x00 },  /* c to c */
  { 0x010E,  0x44, 0x00 },  /* D to D */
  { 0x010F,  0x64, 0x00 },  /* d to d */
  { 0x0110,  0x44, 0x00 },  /* Ð to D */
  { 0x0111,  0x64, 0x00 },  /* d to d */
  { 0x0112,  0x45, 0x00 },  /* E to E */
  { 0x0113,  0x65, 0x00 },  /* e to e */
  { 0x0114,  0x45, 0x00 },  /* E to E */
  { 0x0115,  0x65, 0x00 },  /* e to e */
  { 0x0116,  0x45, 0x00 },  /* E to E */
  { 0x0117,  0x65, 0x00 },  /* e to e */
  { 0x0118,  0x45, 0x00 },  /* E to E */
  { 0x0119,  0x65, 0x00 },  /* e to e */
  { 0x011A,  0x45, 0x00 },  /* E to E */
  { 0x011B,  0x65, 0x00 },  /* e to e */
  { 0x011C,  0x47, 0x68 },  /* G to Gh */
  { 0x011D,  0x67, 0x68 },  /* g to gh */
  { 0x011E,  0x47, 0x00 },  /* G to G */
  { 0x011F,  0x67, 0x00 },  /* g to g */
  { 0x0120,  0x47, 0x00 },  /* G to G */
  { 0x0121,  0x67, 0x00 },  /* g to g */
  { 0x0122,  0x47, 0x00 },  /* G to G */
  { 0x0123,  0x67, 0x00 },  /* g to g */
  { 0x0124,  0x48, 0x68 },  /* H to Hh */
  { 0x0125,  0x68, 0x68 },  /* h to hh */
  { 0x0126,  0x48, 0x00 },  /* H to H */
  { 0x0127,  0x68, 0x00 },  /* h to h */
  { 0x0128,  0x49, 0x00 },  /* I to I */
  { 0x0129,  0x69, 0x00 },  /* i to i */
  { 0x012A,  0x49, 0x00 },  /* I to I */
  { 0x012B,  0x69, 0x00 },  /* i to i */
  { 0x012C,  0x49, 0x00 },  /* I to I */
  { 0x012D,  0x69, 0x00 },  /* i to i */
  { 0x012E,  0x49, 0x00 },  /* I to I */
  { 0x012F,  0x69, 0x00 },  /* i to i */
  { 0x0130,  0x49, 0x00 },  /* I to I */
  { 0x0131,  0x69, 0x00 },  /* i to i */
  { 0x0132,  0x49, 0x4A },  /* ? to IJ */
  { 0x0133,  0x69, 0x6A },  /* ? to ij */
  { 0x0134,  0x4A, 0x68 },  /* J to Jh */
  { 0x0135,  0x6A, 0x68 },  /* j to jh */
  { 0x0136,  0x4B, 0x00 },  /* K to K */
  { 0x0137,  0x6B, 0x00 },  /* k to k */
  { 0x0138,  0x6B, 0x00 },  /* ? to k */
  { 0x0139,  0x4C, 0x00 },  /* L to L */
  { 0x013A,  0x6C, 0x00 },  /* l to l */
  { 0x013B,  0x4C, 0x00 },  /* L to L */
  { 0x013C,  0x6C, 0x00 },  /* l to l */
  { 0x013D,  0x4C, 0x00 },  /* L to L */
  { 0x013E,  0x6C, 0x00 },  /* l to l */
  { 0x013F,  0x4C, 0x2E },  /* ? to L. */
  { 0x0140,  0x6C, 0x2E },  /* ? to l. */
  { 0x0141,  0x4C, 0x00 },  /* L to L */
  { 0x0142,  0x6C, 0x00 },  /* l to l */
  { 0x0143,  0x4E, 0x00 },  /* N to N */
  { 0x0144,  0x6E, 0x00 },  /* n to n */
  { 0x0145,  0x4E, 0x00 },  /* N to N */
  { 0x0146,  0x6E, 0x00 },  /* n to n */
  { 0x0147,  0x4E, 0x00 },  /* N to N */
  { 0x0148,  0x6E, 0x00 },  /* n to n */
  { 0x0149,  0x27, 0x6E },  /* ? to 'n */
  { 0x014A,  0x4E, 0x47 },  /* ? to NG */
  { 0x014B,  0x6E, 0x67 },  /* ? to ng */
  { 0x014C,  0x4F, 0x00 },  /* O to O */
  { 0x014D,  0x6F, 0x00 },  /* o to o */
  { 0x014E,  0x4F, 0x00 },  /* O to O */
  { 0x014F,  0x6F, 0x00 },  /* o to o */
  { 0x0150,  0x4F, 0x00 },  /* O to O */
  { 0x0151,  0x6F, 0x00 },  /* o to o */
  { 0x0152,  0x4F, 0x45 },  /* Œ to OE */
  { 0x0153,  0x6F, 0x65 },  /* œ to oe */
  { 0x0154,  0x52, 0x00 },  /* R to R */
  { 0x0155,  0x72, 0x00 },  /* r to r */
  { 0x0156,  0x52, 0x00 },  /* R to R */
  { 0x0157,  0x72, 0x00 },  /* r to r */
  { 0x0158,  0x52, 0x00 },  /* R to R */
  { 0x0159,  0x72, 0x00 },  /* r to r */
  { 0x015A,  0x53, 0x00 },  /* S to S */
  { 0x015B,  0x73, 0x00 },  /* s to s */
  { 0x015C,  0x53, 0x68 },  /* S to Sh */
  { 0x015D,  0x73, 0x68 },  /* s to sh */
  { 0x015E,  0x53, 0x00 },  /* S to S */
  { 0x015F,  0x73, 0x00 },  /* s to s */
  { 0x0160,  0x53, 0x00 },  /* Š to S */
  { 0x0161,  0x73, 0x00 },  /* š to s */
  { 0x0162,  0x54, 0x00 },  /* T to T */
  { 0x0163,  0x74, 0x00 },  /* t to t */
  { 0x0164,  0x54, 0x00 },  /* T to T */
  { 0x0165,  0x74, 0x00 },  /* t to t */
  { 0x0166,  0x54, 0x00 },  /* T to T */
  { 0x0167,  0x74, 0x00 },  /* t to t */
  { 0x0168,  0x55, 0x00 },  /* U to U */
  { 0x0169,  0x75, 0x00 },  /* u to u */
  { 0x016A,  0x55, 0x00 },  /* U to U */
  { 0x016B,  0x75, 0x00 },  /* u to u */
  { 0x016C,  0x55, 0x00 },  /* U to U */
  { 0x016D,  0x75, 0x00 },  /* u to u */
  { 0x016E,  0x55, 0x00 },  /* U to U */
  { 0x016F,  0x75, 0x00 },  /* u to u */
  { 0x0170,  0x55, 0x00 },  /* U to U */
  { 0x0171,  0x75, 0x00 },  /* u to u */
  { 0x0172,  0x55, 0x00 },  /* U to U */
  { 0x0173,  0x75, 0x00 },  /* u to u */
  { 0x0174,  0x57, 0x00 },  /* W to W */
  { 0x0175,  0x77, 0x00 },  /* w to w */
  { 0x0176,  0x59, 0x00 },  /* Y to Y */
  { 0x0177,  0x79, 0x00 },  /* y to y */
  { 0x0178,  0x59, 0x00 },  /* Ÿ to Y */
  { 0x0179,  0x5A, 0x00 },  /* Z to Z */
  { 0x017A,  0x7A, 0x00 },  /* z to z */
  { 0x017B,  0x5A, 0x00 },  /* Z to Z */
  { 0x017C,  0x7A, 0x00 },  /* z to z */
  ...
  { 0x03B1,  0x61, 0x00 },  /* a to a */
  { 0x03B2,  0x62, 0x00 },  /* ß to b */
  { 0x03B3,  0x67, 0x00 },  /* ? to g */
  { 0x03B4,  0x64, 0x00 },  /* d to d */
  { 0x03B5,  0x65, 0x00 },  /* e to e */
  ...
  { 0x03BC,  0x6d, 0x00 },  /* µ to m */
  { 0x03BD,  0x6e, 0x00 },  /* ? to n */
  { 0x03BE,  0x78, 0x00 },  /* ? to x */
  { 0x03BF,  0x6f, 0x00 },  /* ? to o */
  { 0x03C0,  0x70, 0x00 },  /* p to p */
  { 0x03C1,  0x72, 0x00 },  /* ? to r */
  { 0x03C3,  0x73, 0x00 },  /* s to s */
  { 0x03C4,  0x74, 0x00 },  /* t to t */
  { 0x03C5,  0x79, 0x00 },  /* ? to y */
  { 0x03C6,  0x66, 0x00 },  /* f to f */
