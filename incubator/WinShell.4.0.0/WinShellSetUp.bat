@REM
@REM Copyright (c) 2008-2008 Rexx Language Association. All rights reserved.
@REM
...
@REM This is a simple batch file that can be used to temporarily add the
@REM necessary WinShell files to the path.  Use this if you do not want to
@REM permanently add the path to your environment.

for /F "usebackq tokens=1,*" %%i in (`cd`) do set WS_DIR=%%i\bin
set PATH=%WS_DIR%;%PATH%
