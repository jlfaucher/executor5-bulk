 ...
 * <ul>
 *   <li>{@link org.oorexx.workbench.rexx.impl.AttributeImpl#getVisibility <em>Visibility</em>}</li>
 *   <li>{@link org.oorexx.workbench.rexx.impl.AttributeImpl#isClass <em>Class</em>}</li>
 *   <li>{@link org.oorexx.workbench.rexx.impl.AttributeImpl#getExpose <em>Expose</em>}</li>
 *   <li>{@link org.oorexx.workbench.rexx.impl.AttributeImpl#getContent <em>Content</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AttributeImpl extends ClassContentImpl implements Attribute
{
  ...
  {
    return RexxPackage.Literals.ATTRIBUTE;
  }
  ...
  public void setVisibility(VISIBILITY newVisibility)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RexxPackage.ATTRIBUTE__VISIBILITY, oldVisibility, visibility));
  }
  ...
  public void setClass(boolean newClass)
  {
    ...
    class_ = newClass;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RexxPackage.ATTRIBUTE__CLASS, oldClass, class_));
  }
  ...
  public EList<String> getExpose()
  {
    if (expose == null)
    {
      expose = new EDataTypeEList<String>(String.class, this, RexxPackage.ATTRIBUTE__EXPOSE);
    }
    return expose;
  }
  ...
  public EList<Instruction> getContent()
  {
    if (content == null)
    {
      content = new EObjectContainmentEList<Instruction>(Instruction.class, this, RexxPackage.ATTRIBUTE__CONTENT);
    }
    return content;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RexxPackage.ATTRIBUTE__CONTENT:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RexxPackage.ATTRIBUTE__VISIBILITY:
        return getVisibility();
      case RexxPackage.ATTRIBUTE__CLASS:
        return isClass();
      case RexxPackage.ATTRIBUTE__EXPOSE:
        return getExpose();
      case RexxPackage.ATTRIBUTE__CONTENT:
        return getContent();
    }
