 ...
 * <ul>
 *   <li>{@link org.oorexx.workbench.rexx.impl.RequiresImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RequiresImpl extends MinimalEObjectImpl.Container implements Requires
{
  ...
  {
    return RexxPackage.Literals.REQUIRES;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RexxPackage.REQUIRES__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RexxPackage.REQUIRES__NAME:
        return getName();
    }
