...
<sect1 id="errorlist"><title>Error List</title>

<xsl:for-each select="Message[Code &lt; 101]">
<xsl:sort select="Code" data-type="number"/>
<xsl:text>
</xsl:text>
<xsl:element name="sect2"> <xsl:attribute name="id">ERR<xsl:value-of select="Code"/></xsl:attribute>
...
</xsl:text><sect1 id="rxsubcomup"><title>RXSUBCOM Utility Program</title>
<xsl:text>
</xsl:text>
...
<xsl:element name="sect2"> <xsl:attribute name="id">ERR<xsl:value-of select="MessageNumber"/></xsl:attribute>
...
<sect1 id="rxqueueup"><title>RXQUEUE Utility Program</title>
...
<sect1 id="rexxcup"><title>RexxC Utility Program</title>
