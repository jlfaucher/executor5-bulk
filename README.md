# Experimental ooRexx5

Forked from [https://sourceforge.net/p/oorexx/code-0/HEAD/tree][sourceforge].

Unlike [Executor5][executor5], this repository includes everything from
[SourceForge][sourceforge]: trunk, branches, releases, docs, tests, incubator, sandboxes.
