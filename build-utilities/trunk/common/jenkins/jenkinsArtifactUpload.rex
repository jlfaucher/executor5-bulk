-- Upload built ooRexx Artifacts (installers) to Sourceforge
-- Modified copy of jenkinsZIPArtifactUpload enable control of uploaded version POJ 2025-05-31
...
-- here the regular items are picked up
...
/*
   usage:   jenkinsArtifactUpload.rex [targetDirectory [version]]
            jenkinsArtifactUpload.rex 5.2.0beta 5.2.0
*/
...
::constant validExtensions ("deb", "rpm", "pkg", "dmg", "exe", "tar.gz")
