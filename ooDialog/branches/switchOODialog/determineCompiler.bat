...
REM    also sets SWITCH_ROOT_DIR because this is easy to do in a batch file, but
REM    difficult to do in a nMake make file.
REM - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -

pushd ..\

set SWITCH_ROOT_DIR=%cd%
...
echo SWITCH_ROOT_DIR=%SWITCH_ROOT_DIR% >> compiler.info.incl
