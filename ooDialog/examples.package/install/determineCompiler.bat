...
REM    also sets PACKAGE_ROOT_DIR because this is easy to do in a batch file,
REM    but difficult to do in a nMake make file.
REM
REM    It is simply a copy of some of the stuff from makeorx.bat.
REM
REM    There are easier ways to do this for the Extra ooDialog Examples package,
REM    but this file was already available and tested, so it is simple to just
REM    use it.
REM - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
echo PACKAGE_ROOT_DIR=%PACKAGE_ROOT_DIR% >> compiler.info.incl
