...
call execute .resources~inString_outString, 70, 10
say
...
call execute .resources~inString_outArray, 85, 10
say
...
call execute .resources~inArray_outString, 85, 10
say
...
call execute .resources~inArray_outArray, 90, 10
say
...
::routine execute
    ...
    i = 1
    do test over tests
        isComment = test~strip~startsWith("--")
        if i == 1 then do
