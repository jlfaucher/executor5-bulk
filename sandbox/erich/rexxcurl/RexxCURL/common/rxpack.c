...
static char RCSid[] = "$Id: rxpack.c,v 1.93 2019/02/09 06:08:08 mark Exp $";
 ...
 *----------------------------------------------------------------------------*/
int SetRexxVariable( RxPackageGlobalDataDef *RxPackageGlobalData, char *name, int namelen, char *value, int valuelen )
{
   ULONG rc=0L;
   SHVBLOCK shv;
