/* This is the supporting header file for OS/2 threads.
 * Checked with gcc 3.?
...
#define THREAD_PROTECT(varname) RxPackSetMutex(&varname); {
#define THREAD_UNPROTECT(varname) } RxPackUnsetMutex(&varname);
