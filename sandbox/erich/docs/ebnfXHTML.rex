...
do xhtml over xhtmls
  ...
  do while xml~skipTo('<xhtml:a name="')
    ...
    tags = fixItalicAndLinks(xml~get)  -- collect SVG data, and fix it
...
say
say "Totals:"
say xhtmls~items "HTMLs," svgsAllIdentical~items "identical," svgsAllChanged~items "changed, and" svgsNew~items "new SVGs" 
